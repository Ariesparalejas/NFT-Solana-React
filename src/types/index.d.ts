...
declare namespace Solana {
  ...
  export class SolanaToken {
    ...
    avgPrice?: number;
    percFromFloor?: number;
    mostRecentTxn?: NasusSolanaTransaction;
    createdAt?: Date;
    updatedAt?: Date;
    nasusThumbnailImageUrl?: string
    collectionSymbol?: string
  }
  ...
  export interface AnalyzePortfolioJobState {
    ...
    readonly nasusTxnCount?: number;
    readonly createdAt: Date;
    readonly updatedAt: Date;
  }
  export class NasusSolanaTransaction {
    id: string;
